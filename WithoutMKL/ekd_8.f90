...
!...kdelta is simple kronecker delta
   ...
   a = r*r
   w1 = -2.0d0*765765.0d0*a*ht**9.0d0*(25025.0d0*a**3.0d0 - 163800.0d0*a**2.0d0*ht**2.0d0 + 166320.0d0*a*ht**4.0d0 - 27456.0d0*ht**6.0d0)
   w1 = w1/(4927697775.0d0*a*ht**8.0d0)
   ...
   x1 = 2.0d0*765765.0d0*ht**9.0d0*(-425425.0d0*a**4.0d0 + 3712800.0d0*a**3.0d0*ht**2.0d0 - 5654880.0d0*a**2.0d0*ht**4.0d0 + 1867008.0d0*a*ht**6.0d0 + 1464320.0d0*ht**8.0d0)
   x1 = -x1/(670166897400.0d0*ht**8.0d0)

   B1=0.0d0

   do l = 1,2
        do k = 1,2
		     B1(l,k)=phi/(ht**8.0d0)*(w1*temp(l)*temp(k)+x1*kdelta(k,l))
        enddo
   enddo
B1(3,3)=1.0d0
...
!...kdelta is kronecker delta	
   ...
   w2 = -57344.0d0*r**17.0d0 + 2002366080.0d0*r**9.0d0*ht**8.0d0 - 50459625216.0d0*r**7.0d0*ht**10.0d0 + 122644922400.0d0*r**5.0d0*ht**12.0d0 - 52562109600.0d0*r**3.0d0*ht**14.0d0 + &
        57344.0d0*a**8.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - 114688.0d0*a**7.0d0*ht**2.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 344064.0d0*a**6.0d0*ht**4.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - &
        1146880.0d0*a**5.0d0*ht**6.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - 1998352000.0d0*a**4.0d0*ht**8.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 35286637563.0d0*a**3.0d0*ht**10.0d0*&
        dsqrt(a + 4.0d0*ht**2.0d0) - 58991025456.0d0*a**2.0d0*ht**12.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 15085472688.0d0*a*ht**14.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + &
        2061259200.0d0*ht**16.0d0*dsqrt(a + 4.0d0*ht**2.0d0)        
			   
   w2 = w2*4.0d0
   
   w2 = w2 + 2.0d0*765765.0d0*a*ht**9.0d0*(25025.0d0*a**3.0d0 - 163800.0d0*a**2.0d0*ht**2.0d0 + 166320.0d0*a*ht**4.0d0 - 27456.0d0*ht**6.0d0)*dlog(2.0d0*ht + dsqrt(a + 4.0d0*ht**2.0)) 
   
   w2 = w2/(4927697775.0d0*a*ht**8.0d0)

   !...evaluated w2			   			      

   x2 = -458752.0d0*r**17.0d0 + 30257976320.0d0*r**9.0d0*ht**8.0d0 - 980358432768.0d0*r**7.0d0*ht**10.0d0 + 3335941889280.0d0*r**5.0d0*ht**12.0d0 - 2382815635200.0d0*r**3.0d0*ht**14.0d0 + &
        458752.0d0*a**8.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - 917504.0d0*a**7.0d0*ht**2.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 2752512.0d0*a**6.0d0*ht**4.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - &
        9175040.0d0*a**5.0d0*ht**6.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - 30225863680.0d0*a**4.0d0*ht**8.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 714983204779.0d0*a**3.0d0*ht**10.0d0*&
        dsqrt(a + 4.0d0*ht**2.0d0) - 1765915566888.0d0*a**2.0d0*ht**12.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 848488230304.0d0*a*ht**14.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + &
        269233169920.0d0*ht**16.0d0*dsqrt(a + 4.0d0*ht**2.0d0)  
			   
   x2 = x2*4.0d0
   
   x2 = x2 - 2.0d0*765765.0d0*ht**9.0d0*(-425425.0d0*a**4.0d0 + 3712800.0d0*a**3.0d0*ht**2.0d0 - 5654880.0d0*a**2.0d0*ht**4.0d0 + 1867008.0d0*a*ht**6.0d0 + 1464320.0d0*ht**8.0d0)*&
        dlog(2.0d0*ht + dsqrt(a + 4.0d0*ht**2.0d0))

   x2 = -x2/(670166897400.0d0*ht**8.0d0)
   ...
   do l = 1,2
        do k = 1,2
		     B2(l,k) = phi/(ht**8.0d0)*(w2*temp(l)*temp(k)+x2*kdelta(k,l))
        enddo
   enddo
...
z1 = 2.0d0/51480.0d0*ht**9.0d0*(25025.0d0*a**3.0d0 - 122850.0d0*a**2.0d0*ht**2.0d0 + 83160.0d0*a*ht**4.0d0 - 6864.0d0*ht**6.0d0)

y1 = -2.0d0*45045.0d0*a*ht**9.0d0*(715.0d0*a**2.0d0 - 2340.0d0*a*ht**2.0d0 + 792.0d0*ht**4.0d0)
y1 = y1/(11042460.0d0*a)

temporary1 = 64.0d0*z1*phi/(ht**16.0d0)

temporary2 = 64.0d0*y1*phi/(ht**16.0d0) 
...
z2 = 7168.0d0*r**15.0d0 - 132509520.0d0*r**7.0d0*ht**8.0d0 + 2597186592.0d0*r**5.0d0*ht**10.0d0 - 4509004500.0d0*r**3.0d0*ht**12.0d0 + &
     1159458300.0d0*r*ht**14.0d0 - 7168.0d0*a**7.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 14336.0d0*a**6.0d0*ht**2.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - &
     43008.0d0*a**5.0d0*ht**4.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 143360.0d0*a**4.0d0*ht**6.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + &
     132007760.0d0*a**3.0d0*ht**8.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - 1733148171.0d0*a**2.0d0*ht**10.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + &
     1952030322.0d0*a*ht**12.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - 264282876.0d0*ht**14.0d0*dsqrt(a + 4.0d0*ht**2.0d0)

z2 = z2/579729150.0d0

z2 = z2 - 2.0d0/51480.0d0*ht**9.0d0*(25025.0d0*a**3.0d0 - 122850.0d0*a**2.0d0*ht**2.0d0 + 83160.0d0*a*ht**4.0d0 - 6864.0d0*ht**6.0d0)*dlog(2.0d0*ht + dsqrt(a + 4.0d0*ht**2.0)) 

y2 = -512.0d0*r**15.0d0 + 4416984.0d0*r**7.0d0*ht**8.0d0 - 61837776.0d0*r**5.0d0*ht**10.0d0 + 64414350.0d0*r**3.0d0*ht**12.0d0 - &
     5521230.0d0*r*ht**14.0d0 + 512.0d0*a**7.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - 1024.0d0*a**6.0d0*ht**2.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + &
     3072.0d0*a**5.0d0*ht**4.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - 10240.0d0*a**4.0d0*ht**6.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - &
     4381144.0d0*a**3.0d0*ht**8.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 38335545.0d0*a**2.0d0*ht**10.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - &
     22827618.0d0*a*ht**12.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 368082.0d0*ht**14.0d0*dsqrt(a + 4.0d0*ht**2.0d0)

y2 = y2*4.0d0

y2 = y2 + 2.0d0*45045.0d0*a*ht**9.0d0*(715.0d0*a**2.0d0 - 2340.0d0*a*ht**2.0d0 + 792.0d0*ht**4.0d0)*dlog(2.0d0*ht + dsqrt(a + 4.0d0*ht**2.0)) 

y2 = y2/(11042460.0d0*a)

temporary1 = 64.0d0*z2*phi/(ht**16.0d0)

temporary2 = 64.0d0*y2*phi/(ht**16.0d0)
