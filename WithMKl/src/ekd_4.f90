...
!...kdelta is simple kronecker delta
   ...
   a = r*r
   w1 = -2.0d0*315.0d0*a*ht**5.0d0*(21.0d0*a - 20.0d0*ht**2.0d0)
   w1 = w1*4.0d0/(11025.0d0*a*ht**4.0d0)
   ...
   x1 = 2.0d0*315.0d0*ht**5.0d0*(-189.0d0*a**2.0d0 + 360.0d0*a*ht**2.0d0 + 448.0d0*ht**4.0d0)
   x1 = -x1/(99225.0d0*ht**4.0d0)

   B1=0.0d0

   do l = 1,2
        do k = 1,2
		     B1(l,k)=phi/(ht**4.0d0)*(w1*temp(l)*temp(k)+x1*kdelta(k,l))
        enddo
   enddo
   B1(3,3) = 1.0d0
...
!...kdelta is kronecker delta	
   ...
   w2 = -8.0d0*r**9.0d0 + 1470.0d0*r**5.0d0*ht**4.0d0 - 7350.0d0*r**3.0d0*ht**6.0d0 + &
        8.0d0*a**4.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - 16.0d0*a**3.0d0*ht**2.0d0*&
        dsqrt(a + 4.0d0*ht**2.0d0) - 1422.0d0*a**2.0d0*ht**4.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + &
        3515.0d0*a*ht**6.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 980.0d0*ht**8.0d0*&
	dsqrt(a + 4.0d0*ht**2.0d0)
			   
   w2 = w2*4.0d0
   
   w2 = w2 + 2.0d0*315.0d0*a*ht**5.0d0*(21.0d0*a - 20.0d0*ht**2.0d0)*&
               dlog(2.0d0*ht + dsqrt(a + 4.0d0*ht**2.0d0))
			   
   w2 = w2*4.0d0
   
   w2 = w2/(11025.0d0*a*ht**4.0d0)

   !...evaluated w2			   			      

   x2 = -32.0d0*r**9.0d0 + 10584.0d0*r**5.0d0*ht**4.0d0 - 88200.0d0*r**3.0d0*ht**6.0d0 + &
        32.0d0*a**4.0d0*dsqrt(a + 4.0d0*ht**2.0d0) - 64.0d0*a**3.0d0*ht**2.0d0*&
        dsqrt(a + 4.0d0*ht**2.0d0) - 10392.0d0*a**2.0d0*ht**4.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + &
	49193.0d0*a*ht**6.0d0*dsqrt(a + 4.0d0*ht**2.0d0) + 34496.0d0*ht**8.0d0*&
	dsqrt(a + 4.0d0*ht**2.0d0)
			   
   x2 = x2*4.0d0
   
   x2 = x2 - 2.0d0*315.0d0*ht**5.0d0*(-189.0d0*a**2.0d0 + 360.0d0*a*ht**2.0d0 + 448.0d0*ht**4.0d0)*&
        dlog(2.0d0*ht + dsqrt(a + 4.0d0*ht**2.0d0))

   x2 = -x2/(99225.0d0*ht**4.0d0)
   ...
   do l = 1,2
        do k = 1,2
		     B2(l,k) = phi/(ht**4.0d0)*(w2*temp(l)*temp(k)+x2*kdelta(k,l))
        enddo
   enddo
...
z1 = 2.0d0*105.0d0*ht**5.0d0*(21.0d0*a - 10.0d0*ht**2.0d0)
z1 = z1/3675.0d0

y1 = -2.0d0*210.0d0*a*ht**5.0d0
y1 = y1/(175.0d0*a)

temporary1 = 16.0d0*z1*phi/(ht**8.0d0)

temporary2 = 16.0d0*y1*phi/(ht**8.0d0) 
...
z2 = 24.0d0*r**7.0d0 - 2450.0d0*r**3.0d0*ht**4.0d0 + 7350.0d0*r*ht**6.0d0 - 24.0d0*a**3.0d0*dsqrt(a+4.0d0*ht**2.0d0) + 48.0d0*a**2.0d0*ht**2.0d0*dsqrt(a+4.0d0*ht**2.0d0) + &
     2306.0d0*a*ht**4.0d0*dsqrt(a+4.0d0*ht**2.0d0) - 2950.0d0*ht**6.0d0*dsqrt(a+4.0d0*ht**2.0d0) - 2.0d0*105.0d0*ht**5.0d0*(21.0d0*a - 10.d0*ht**2.0d0)*&
     dlog(2.0d0*ht+dsqrt(a+4.0d0*ht**2.0d0))

z2 = z2/3675.0d0

y2 = -8.0d0*r**7.0d0 + 350.0d0*r**3.0d0*ht**4.0d0 - 350.0d0*r*ht**6.0d0 + 8.0d0*a**3.0d0*dsqrt(a+4.0d0*ht**2.0d0) - 16.0d0*a**2.0d0*ht**2.0d0*dsqrt(a+4.0d0*ht**2.0d0) - &
     302.0d0*a*ht**4.0d0*dsqrt(a+4.0d0*ht**2.0d0) + 50.0d0*ht**6.0d0*dsqrt(a+4.0d0*ht**2.0d0) + 2.0d0*210.0d0*a*ht**5.0d0*dlog(2.0d0*ht+dsqrt(a+4.0d0*ht**2.0d0))

y2 = y2/(175.0d0*a)

temporary1 = 16.0d0*z2*phi/(ht**8.0d0)

temporary2 = 16.0d0*y2*phi/(ht**8.0d0)
